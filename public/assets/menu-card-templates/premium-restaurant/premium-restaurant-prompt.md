# Premium Restaurant — Reusable Menu Template Prompt

Business name: [CHANGE HERE]
Business category: Premium Restaurant
Design objective: Create a premium A4 printable menu and mobile digital menu based on the The Ember Table sample system.

## Visual direction
Editorial dining menu. Preserve the premium Jiten Creative Co. ecosystem feel while adapting colors, logo, photos, menu content, prices, contact details, and QR destination to the real client.
