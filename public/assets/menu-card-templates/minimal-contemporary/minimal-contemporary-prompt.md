# Minimal Contemporary — reusable design prompt

Create an original, commercially usable **sample menu / service price-list template** for **Form & Fork** as part of the Jiten Creative Co. portfolio. This is a concept design, not a real client case study.

## Art direction
A typography-led menu proving premium design can stay quiet: strict grid, measured rules, and highly visible pricing. Use a flat, print-friendly composition with intentional spacing and no mockup scene. The artwork must be shown directly as the menu itself. Avoid fake claims, reviews, awards, customer counts, invented locations, or client proof.

## Brand system
- Business/sample name: Form & Fork
- Category: Menu / Contemporary
- Palette: canvas #F9F9F7; primary #161817; accent #2E6473; soft surface #C8DAD8; secondary text #6A706D.
...
## Content direction
Include a small set of plates, mains, and something sweet. Let the grid, whitespace, and price alignment do the visual work.
