# Laundry & Dry Cleaning — Reusable Menu Template Prompt

Business name: [CHANGE HERE]
Business category: Laundry & Dry Cleaning
Design objective: Create a premium A4 printable menu and mobile digital menu based on the FreshFold Laundry & Care sample system.

## Visual direction
Clean service price list. Preserve the premium Jiten Creative Co. ecosystem feel while adapting colors, logo, photos, menu content, prices, contact details, and QR destination to the real client.
