# Modern Cafe — reusable design prompt

Create an original, commercially usable **sample menu / service price-list template** for **Oak & Bean Café** as part of the Jiten Creative Co. portfolio. This is a concept design, not a real client case study.

## Art direction
A warm editorial cafe system with clear menu hierarchy, restrained coffee accents, and a relaxed premium tone. Use a flat, print-friendly composition with intentional spacing and no mockup scene. The artwork must be shown directly as the menu itself. Avoid fake claims, reviews, awards, customer counts, invented locations, or client proof.

## Brand system
- Business/sample name: Oak & Bean Café
- Category: Menu / Cafe
- Palette: canvas #F4EEE5; primary #262522; accent #9E5D3B; soft surface #D8C5AE; secondary text #6F7168.
...
## Content direction
Include Coffee, Tea, Cold Beverages, Breakfast, Bakery, and Desserts with realistic sample pricing.
