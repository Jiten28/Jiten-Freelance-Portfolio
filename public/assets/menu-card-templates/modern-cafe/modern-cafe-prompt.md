# Modern Cafe — Reusable Menu Template Prompt

Business name: [CHANGE HERE]
Business category: Modern Cafe
Design objective: Create a premium A4 printable menu and mobile digital menu based on the Oak & Bean Café sample system.

## Visual direction
Warm modern café menu. Preserve the premium Jiten Creative Co. ecosystem feel while adapting colors, logo, photos, menu content, prices, contact details, and QR destination to the real client.
